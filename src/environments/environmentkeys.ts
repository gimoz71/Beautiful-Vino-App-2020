...
export const environment = {
  ...
  ESITO_KO_CODICE_ERRORE_GET: 500,
    AWS_UPLOADBUCKET_ACCESS_KEY: 'AKIAQTIOAAFZBGY23WOQ',
    AWS_UPLOADBUCKET_SECRETACCESS_KEY: '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',
    AWS_UPLOADBUCKET_REGION: 'eu-central-1',
    AWS_UPLOADBUCKET_BUCKETNAME: 'beautifulvino2020-immagini',
    GOOGLE_MAP_API_KEY: 'AIzaSyC0sSGnMFiSAJJ7tInpM3fujWEf4KPtokM'
};
